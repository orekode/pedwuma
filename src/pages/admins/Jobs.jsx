                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    {typeof(data) != 'undefined' && 
                        data[0]?.map((row) => {
                            ...
                            let status = safeGet(row, ["Job Status"], "Pending");
                            ...
                            return (
                                ...
                                <TableCell>{safeGet(row, ["jobDetails", "Service Information", "Service Provided"], "")}</TableCell>
                                
                                <TableCell>Ghc{
                                    safeGet(row, ["Charge"], 
                                    safeGet(row, ["jobDetails", "Service Information", "Charge"], ""))} / {safeGet(row, ["Charge Rate"], safeGet(row, ["jobDetails", "Service Information", "Charge Rate"], ""))}
                                </TableCell>
                                ...
                                <TableCell>
                                    <Btn.SmallBtn onClick={() => navigate(`/admin/job/${encrypt(row.id)}`)}>View Details</Btn.SmallBtn>
                                </TableCell>
                                </TableRow>
                            );
