...
export default function() {
    ...
    return (
        <section>
            ...
            <EmptyBox load={typeof(data) != 'undefined' && data[0]?.length <= 0} title="No Bookings On This Page" text="Please check other pages or move to our workers page to book a service worker today" link={["Our Workers", "/workers"]}/>
